...
<div class="row" style="width:80%;margin:auto;">
  ...
  <div class="col-md-4 list-group">
	...
	<form method="post" action="Script.php" name="frm_login">
	  ...
	  <br> 
	  <input type="submit" class="btn btn-primary" value="Login" id="log_btn"><br> <a href="recover_password.php" style="font-weight:normal;color:gray">Reset my password</a>
  ...
  <div class="col-md-4 list-group">
    ...
    <form method="post" action="Script.php" name="frm_signup_1" id="signup_frm">
    <input type="hidden" name="frm_signup_1" value="true"/>

	Student ID
	<input type="text" name="student_id" placeholder="Entre your student ID" class="form-control" required="" id="std_id">
	<br>

	<div class="btnsignup" style="padding-top:58px">
	  <input type="submit" name="frm_signup_1" class="btn btn-primary" value="Next" id="next_btn"> <br> Click Next to set up password
